...
const t = {
  en: {
    ...
    freeMethods: [
      'Place your QR code in fitness studios, gyms, sports clubs, wellness centers, and training facilities where active communities gather.',
      'Partner with fitness coaches, sports clubs, and social media influencers to share the QR code with their audience on posters, cards, stories, and phone screens.',
    ...
    qrAudience: 'Especially effective for fitness studios, sports clubs, wellness centers, and social media influencers, as well as business owners, factory managers, and partners in hotels, malls, stores, travel agencies, waiting rooms, and service hubs.',
    qrBenefits: [
  ...
  ro: {
    ...
    freeMethods: [
      'Plasează codul tău QR în săli de fitness, săli de sport, cluburi sportive, centre de wellness și spații de antrenament unde se întâlnesc comunități active.',
      'Colaborează cu antrenori de fitness, cluburi sportive și influenceri din social media pentru a distribui codul QR prin postere, cărți de vizită, story-uri și ecrane de telefon.',
    ...
    qrAudience: 'Deosebit de eficient pentru săli de fitness, cluburi sportive, centre de wellness și influenceri din social media, precum și pentru proprietari de afaceri, manageri în fabrici și parteneri din hoteluri, mall-uri, magazine, agenții de voiaj, săli de așteptare și hub-uri de servicii.',
    qrBenefits: [
