...
const t = {
  en: {
    ...
    desc: 'As an affiliate partner, you can earn up to $500 per activated investor, depending on the country tier. What would it mean to invest just $150 for a potential x 1000 profit opportunity in 10 weeks, $153,600? Investors receive free TradingView Pro, a free Pine Script robot created with AI, and access to Copy Trading. Deposit split into 15 units for 4 Martingale levels.',
  ...
  ro: {
    ...
    desc: 'Ca partener afiliat, poți câștiga până la $500 pentru fiecare investitor activat, în funcție de grupa țării. Cum înțelegi că este să investești doar $150 pentru o oportunitate de profit de x 1000 în 10 săptămâni, $153,600? Investitorii primesc TradingView Pro gratuit, un robot Pine Script creat cu AI și acces la Copy Trading. Depozitul este împărțit în 15 unități pentru 4 niveluri Martingale.',
